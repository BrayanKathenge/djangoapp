"""
URL configuration for B_siperEcommercedjangoProject project.
...
urlpatterns = [
    ...
    path('addproduct/', user_views.addproduct, name='add-product'),
    path('allproduct/', user_views.all_products, name='all-products'),
